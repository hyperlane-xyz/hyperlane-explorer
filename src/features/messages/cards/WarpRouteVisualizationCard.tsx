        ...
        <div className="mt-4 space-y-4">
          ...
          <div className="flex justify-center">
            <button
              ...
              className="flex items-center gap-2 rounded-md border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-primary-50 disabled:cursor-not-allowed disabled:opacity-50"
            >
              {isBalancesLoading ? (
