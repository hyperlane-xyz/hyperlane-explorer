...
const KNOWN_CHAIN_COLORS: Record<string, ChainColors> = {
  ...
  optimism: { primary: '#FF0420', secondary: '#FF0420' },
  base: { primary: '#0052FF', secondary: '#0052FF' },
  avalanche: { primary: '#E84142', secondary: '#E84142' },
  bsc: { primary: '#F0B90B', secondary: '#F0B90B' },
  binance: { primary: '#F0B90B', secondary: '#F0B90B' },
};
